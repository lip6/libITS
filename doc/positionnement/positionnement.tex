...
La figure~\ref{fig:owcty} présente l'algorithme OWCTY. Il a été modifié par rapport à celui présenté dans~\cite{FFKV01}. Les parcours ont été inversé pour être en avant. Ceci a pour conséquence que les fonctions \texttt{Post} et \texttt{Sat} ne peuvent pas sortir de l'ensemble $B$ et cela nous permet de supprimer quelques intersection. Enfin, la première boucle (ligne 5 et 6) a été ajoutée.
