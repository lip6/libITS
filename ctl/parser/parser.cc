...
formulae
parse_file( const std::string& file_name , const property_factory& factory )
{
  ...
  // argument.
  //
  fName = (pANTLR3_UINT8)file_name.c_str(); // Note in VS2005 debug, working directory must be configured
  ...
  //
  lxr = ctlLexerNew(input);	    // CLexerNew is generated by ANTLR
  ...
  //
  psr = ctlParserNew(tstream);  // CParserNew is generated by ANTLR3
